                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full py-20">
                    ...
                    <div className="flex flex-col justify-center space-y-6 text-center md:text-left">
                        ...
                        <div className="flex justify-center md:justify-start gap-4 mt-4">
                            <button className="bg-blue-500 hover:bg-blue-900 text-white py-2 px-6 rounded-md transition duration-300 flex items-center gap-2 cursor-pointer shadow-lg hover:shadow-blue-500/50">
